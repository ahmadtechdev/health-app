...
class AdminHospitalsPublic extends StatefulWidget {
  const AdminHospitalsPublic({super.key});

  @override
  State<AdminHospitalsPublic> createState() => _AdminHospitalsPublicState();
}

class _AdminHospitalsPublicState extends State<AdminHospitalsPublic> {
