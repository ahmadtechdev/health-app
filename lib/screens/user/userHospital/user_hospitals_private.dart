...
class UserHospitalsPrivate extends StatefulWidget {
  const UserHospitalsPrivate({super.key});

  @override
  State<UserHospitalsPrivate> createState() => _UserHospitalsPrivateState();
}

class _UserHospitalsPrivateState extends State<UserHospitalsPrivate> {
